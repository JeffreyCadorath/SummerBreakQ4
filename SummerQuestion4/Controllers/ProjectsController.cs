...
namespace SummerQuestion4.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        public ActionResult AssignToRole()
        {
        ...
        public ActionResult ProjectDisplay()
        {
            ...
            {
                return View(taskHelper.orderByProjectPriority());
            }
            else
            {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Priority,DueDate")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Priority,DueDate")] Project project)
        {
            if (ModelState.IsValid)
            {
